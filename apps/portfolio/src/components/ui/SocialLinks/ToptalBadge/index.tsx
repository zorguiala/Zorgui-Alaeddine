export const ToptalBadge = () => {
  const polygonPath = "polygon(50% 0, 100% 24%, 100% 76%, 50% 100%, 0 76%, 0 24%)";

  return (
    <div className="flex justify-center p-4 font-sans text-center">
      <div 
        className="bg-[#25a9ef] p-[6px]" 
        style={{ clipPath: polygonPath }}
      >
        <div 
          className="flex w-[200px] flex-col items-center gap-2 py-6 pb-10 shadow-2xl"
          style={{ 
        ...
        >
          ...
          <h3 className="m-0 text-[19px] font-bold leading-none text-[#204ecf]">
            TOP 3% TALENT
          </h3>

          <div className="h-[1px] w-[120px] bg-[#25a9ef]" />

          <span className="mb-[-6px] text-base text-[#204ecf]">Vetted by</span>

          <svg className="w-[100px]" viewBox="0 0 108 30" xmlns="http://www.w3.org/2000/svg">
          ...
          <a 
            ...
            className="mt-2 flex h-8 items-center justify-center rounded-md bg-[#296bff] px-5 text-sm font-medium text-white transition-colors hover:bg-[#1e50cc] no-underline"
            href="https://www.toptal.com/developers/resume/alaeddine-zorgui#qK79WE"
          >
            Hire me
          </a>
        </div>
